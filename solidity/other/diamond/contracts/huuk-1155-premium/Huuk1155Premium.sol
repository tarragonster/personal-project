    ...
    UUPSUpgradeable
{
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        require(
            _exists(_id),
            "Huuk1155Premium: URI query for nonexistent token"
        );
    ...
    modifier adminGuard() {
        require(
            ...
            "Huuk1155Premium: must have admin role"
        );
        _;
    }
    ...
    modifier verifiedUserGuard() {
        require(
            ...
            "Huuk1155Premium: must have verified role"
        );
        _;
    }
    ...
    modifier verifiedUserLazyMint(address _owner) {
        require(
            ...
            "Huuk1155Premium: lazymint-owner must have verified role"
        );
        _;
    }
    ...
    modifier pauserGuard() {
        require(
            ...
            "Huuk1155Premium: must have pauser role"
        );
        _;
    }
    ...
    function create(
        ...
        string memory _uri,
        bytes memory _data
    ) public verifiedUserGuard returns (uint256 tokenId) {
        require(
            _initialSupply <= _maxSupply,
            "Huuk1155Premium: initial supply cannot be more than max supply"
        );
        require(
            0 <= _royaltyFee && _royaltyFee <= 10000,
            "Huuk1155Premium: invalid-royalty-fee"
        );
    ...
    function mint(
        ...
        require(
            ...
            "Huuk1155Premium: only-creator-can-mint"
        );
        require(
            tokenSupplys[tokenId] < tokenMaxSupplys[tokenId],
            "Huuk1155Premium: max supply reached"
        );
    ...
    function create(
    ...
    ) public verifiedUserLazyMint(_owner) returns (uint256 tokenId) {
        require(!executed[_nonce], "Huuk1155Premium: duplicated nonce");
        ...
        require(
            ...
            "Huuk1155Premium: signer and owner mismatched"
        );
